					...
					<div className='row'>
						<div className='col-md-6'>
							<form id='contactForm' onSubmit={handleSubmit}>
								...
								<input type='text' id='name' name='name' value={formData.name} onChange={handleChange} placeholder='Steve Milner' required />

								<input type='email' id='mail' name='mail' value={formData.mail} onChange={handleChange} placeholder='hello@websitename.com' required />
