	...
	return (
		<div className='bg-gray-100 min-h-screen flex flex-col justify-center items-center p-4'>
			<div className='max-w-md w-full text-center'>
				...
				<p className='text-lg md:text-xl text-gray-600 mb-8 px-4'>Explore photos of every events that occurred at our institute. It usually takes a 5 to 10 seconds to login and signup bcs of free server have patience</p>
